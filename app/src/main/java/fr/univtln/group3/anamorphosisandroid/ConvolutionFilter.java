...
public class ConvolutionFilter
{
     ...
     */
    private static Bitmap computeConvolution3x3(Bitmap bmp, Matrix mat, float factor, int offset) {
    ...
    public static Bitmap gaussianBlurFilter(Bitmap source){
        ...
        source = computeConvolution3x3(source, gaussianBlur,16,0);
    ...
    public static Bitmap sharpenFilter(Bitmap source){
        ...
        source = computeConvolution3x3(source, sharpen, 3,0);
    ...
    public static Bitmap sharpenSearchingFilter(Bitmap source){
        ...
        source = computeConvolution3x3(source,sharpenSearching,3,1);
    ...
    public static Bitmap engraveFilter(Bitmap source) {
        ...
        source = computeConvolution3x3(source, engrave, 1, 95);
    ...
    public static Bitmap smoothFilter(Bitmap source){
        ...
        source = computeConvolution3x3(source, smooth, 13,1);

        return source;
    }

    /** Les méthodes suivantes n'utilisent pas le système avec matrice de convolution **/
    ...
    /*double[][] meanRemoval = new double[][]{
            { -1 , -1 , -1 },
            { -1 ,  9 , -1 },
            { -1 , -1 , -1 }
    };

    double[][] mrtlMatrix = new double[][]{
            { -1, -1, -1 },
            { -1,  8, -1 },
            { -1, -1, -1 }
    };

    double[][] reverseMrtlMatrix = new double[][]{
            { 1,  1 , 1 },
            { 1, -8 , 1 },
            { 1,  1 , 1 }
    };*/
